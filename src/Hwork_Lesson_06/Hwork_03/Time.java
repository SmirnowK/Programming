...
// из диапазона от 0 до 28800, далее оно должно выводиться на экран
...
public class Time {
    public static void main(String[] args) {
        ...
        System.out.println("Left " + timeConverter.timeSecond + " Second.");

        if (timeConverter.timeSecond > 3600) {
            System.out.println("Left " + timeConverter.timeHour + " Hour.");
        } else if (timeConverter.timeSecond < 3600) System.out.println("less than an hour left");
    }
}